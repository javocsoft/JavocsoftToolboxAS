 ...
 * 
 */
package es.javocsoft.android.lib.toolbox.firebase.core.beans;

import java.util.List;


/**
 * This class conatins an HTTP GCM delivery result
 * response.<br><br>
 * 
 ...
 *
 */
public class FirebaseDeliveryResponse {
	 ...
	 * result. See {@link FirebaseDeliveryResultItem} */
	public List<FirebaseDeliveryResultItem> results;
